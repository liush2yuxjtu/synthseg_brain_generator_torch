...
def metrics_model_tf(input_model, label_list, metrics='dice'):
    """
    TensorFlow/Keras implementation of the metrics model.
    
    :param input_model: Keras model that outputs predictions
    ...
    :return: Keras model that computes the specified metric
    """
    # get prediction
